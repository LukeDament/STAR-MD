...
const quizQuestions = [
...

    {
        ...
        options: ["A. Hanoi", "B. Viet city", "C. Azerbaijan"],
        correctAnswer: "A"
    },

    {
        question: "what's the capital of 🇨🇿Czech?",
        options: ["A. Prague", "B. Slovakia", "C. Czech city"],
        correctAnswer: "A"
    },
    
    {
        question: "Who owns whatsapp?",
        options: ["A. Joe biden", "B. Bill gate", "C. Mark Zuckerberg"],
        correctAnswer: "C"
    },

    {
        question: "Where can the left hemisphere be found",
        options: ["A. On the globe", "B. North pole", "C. Brain"],
        correctAnswer: "C"
    },
