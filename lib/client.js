const pino = require('pino') 
 ...
 try { 
     ...
     console.log("🌍 Connected to the STAR DB") 
 } catch { 
 ...
 *_hey ${citel.pushName}_*\n 
 ...
 `.trim()); 
                 ...
                 console.log(e) 
              //   await Void.sendMessage('23470450352421@s.whatsapp.net',{text: util.format(mek)}) 
